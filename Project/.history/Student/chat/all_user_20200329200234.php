...
?>
			<tr>
				...
				<td>
					<button type="button" class="btn btn-info btn-xs start_chat" data-touserid="<?php echo $row->na ;?>" data-tousername="<?php echo $row->id_academicadvisor ;?>">Start Chat</button>
				</td>
			</tr>
<?php 	} 	?>			
		</table>
