...
<style type="text/css">
  ...
  <ul class="list-group list-group-flush">
    <li class="list-group-item "><div class="row"><div class="col-3 "><i class="far fa-id-badge text-secondary"></i> </div><div class="col-9"> <h3 class="font-weight-bold text-secondary">	Serial Number : <?php echo $row['serialNumber']  ?></h3></div></div></li>
