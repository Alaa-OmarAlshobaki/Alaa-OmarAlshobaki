...
<style type="text/css">
  ...
  <ul class="list-group list-group-flush">
    ...
    <li class="list-group-item"> <h3 class="font-weight-bold  text-secondary">  <h3 class="font-weight-bold"> <i class="fas fa-envelope text-secondary"></i> Email : <?php echo $row['email']  ?></h3></li>
