...
function progress(){
  $id=$_SESSION["id_student"];
       ...
       $con = new mysqli("localhost","root","","traino");
          ...
          return (intval((600-(600-$row['numHours']))/100)."%");
           }
        ...
        <div class="col-md-3 col-sm-6">
            <div class="progress blue">
                ...
                <span class="progress-right">
                    <span class="progress-bar only "><?php    progress(); ?></span>
                </span>
                <div class="progress-value"aria-valuenow="<?php  echo  progress(); ?>" aria-valuemin="0"aria-valuemax="100"><?php    progress(); ?></div>
            </div>
        </div>
