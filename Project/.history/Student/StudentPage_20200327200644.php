...
<style type="text/css">
  ...
  <ul class="list-group list-group-flush">
    <li class="list-group-item "><div class="row"><div class="col-6"></div><div class="col-6"></div></div> <i class="far fa-id-badge text-secondary"></i> <h3 class="font-weight-bold text-secondary">	Serial Number : <?php echo $row['serialNumber']  ?></h3></li>
