...
?>
  ...
  <input type="submit" name="s" value="save"
                                ...
                                if (isset($_POST["s"])) {
                                    $con = new mysqli("localhost", "root", "", "traino");
                                    $id=$_SESSION["id_student"];
                                    $st = $con->prepare('insert into weekly_report values("'. $_POST["Week_number"].'","'. $_POST["date"].'","'. $_POST["trainee_Name"].'","'. $_POST["description"].'","'. $_POST["info"].'","'. $_POST["Supervisor_Name"].'","'. $_POST["Supervisor_Name"].'")');
