...
<style type="text/css">
  ...
  <ul class="list-group list-group-flush">
    <li class="list-group-item "><div class="row"><div class="col-3 h1"><i class="far fa-id-badge text-secondary"></i> </div><div class="col-9"> <h3 class="font-weight-bold text-secondary">	Serial Number : <?php echo $row['serialNumber']  ?></h3></div></div></li>
    ...
    <li class="list-group-item"> <h3 class="font-weight-bold  text-secondary"> <h3 class="font-weight-bold text-secondary"><i class="fas fa-phone text-secondary"></i> Home Phone : <?php echo $row['homenumber']  ?></h3></li>
    <li class="list-group-item"> <h3 class="font-weight-bold  text-secondary">  <h3 class="font-weight-bold text-secondary"> <i class="fas fa-envelope text-secondary"></i> Email : <?php echo $row['email']  ?></h3></li>
