        ...
        if(($_FILES["file"]["type"]=="image/png")||($_FILES["file"]["type"]=="image/jpeg") ||($_FILES["file"]["type"]=="image/jpg") && in_array($file_extension,$valid_extensions))
         {
            ...
            $stm=$connect->prepare("INSERT INTO finalreport (file_data) VALUES (:hostImg)");
...
<input type="file" name="file" class="btn btn-outline-warning">
<input type="submit" name="submit" value="submit" class="btnbtn-danger">
