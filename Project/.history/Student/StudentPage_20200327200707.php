...
<style type="text/css">
  ...
  <ul class="list-group list-group-flush">
    <li class="list-group-item "><div ></div> <i class="far fa-id-badge text-secondary"></i> <h3 class="font-weight-bold text-secondary">	Serial Number : <?php echo $row['serialNumber']  ?></h3></li>
