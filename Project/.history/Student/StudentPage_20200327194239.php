...
<style type="text/css">
  ...
  <ul class="list-group list-group-flush">
    <li class="list-group-item row"> <h3 class="font-weight-bold text-secondary col"><i class="far fa-id-badge text-secondary"></i>	Serial Number : <?php echo $row['serialNumber']  ?></h3></li>
