...
<style type="text/css">
  ...
  <ul class="list-group list-group-flush">
    ...
    <li class="list-group-item"> <h3 class="font-weight-bold  text-secondary"> <h3 class="font-weight-bold text-secondary"><i class="fas fa-phone"></i> Home Phone : <?php echo $row['homenumber']  ?></h3></li>
