                    ...
                    <table class="table table-dark table-hover text-center" style="padding:8px;text-align:center;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="padding-top: 60px"><هىحعف id="numHours" name="numHours" style="width:100px">num of hours</هىحعف></td>
                                <td style="padding-top: 60px"><center><button style="width:100px"  type="submit" name="save"class="btn btn-info ">Submit</button></center>
                                </td>
                        ...
                        if (isset($_POST["save"])) {
                            ...
                            $numH=htmlspecialchars(strip_tags($_POST['numHours']));
                            ...
                            $st->bindParam(':id',$id);
                            $st->bindParam(':Sun',$Sun);
                            $st->bindParam(':Mon',$Mon);
                            $st->bindParam(':Tues',$Tues);
                            $st->bindParam(':Wed',$Wed);
                            $st->bindParam(':Thurs',$Thurs);
                            $st->bindParam(':numH',$numH);
                            $st->execute();
