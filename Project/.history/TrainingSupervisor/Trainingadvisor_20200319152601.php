...
<script type="text/javascript">
  ...
  $(".input1").blur(function(){
    ...
    result=multi($(".btn1").val(),$(".input1").val())
     $(".result1").html(result);
     sum +=result;
     console.log(sum);
     $(".total").html(sum);
    ...
    result=multi($(".btn2").val(),$(".input2").val())
     $(".result2").html(result);
     sum +=result;
     console.log(sum);
     $(".total").html(sum);
  ...
  $(".input3").blur(function(){
   ...
   result=multi($(".btn3").val(),$(".input3").val())
    $(".result3").html(result);
    sum +=result;
    console.log(sum);
    $(".total").html(sum);
                    ...
                    <table class="table table-dark table-hover text-center" style="padding:8px;text-align:center;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="padding-top: 60px"><input type="number"class="form-control has-warning" name="Tues" placeholder="number of hours"></td>
                                <td style="padding-top: 60px"><input type="number"class="form-control has-warning" name="Wed" placeholder="number of hours"></td>
                                <td style="padding-top: 60px"><input type="number"class="form-control has-warning" name="Thurs" placeholder="number of hours"></td>
