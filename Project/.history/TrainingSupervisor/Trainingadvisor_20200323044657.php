...
<script type="text/javascript">
      ...
      $("document").ready(function(){
        $(".custom-select").selected(function(){
           var selectedValue= $(".custom-select").val();
              console.log(selectedValue);
              var select= $("#selected").html(selectedValue);
              console.log(select);
                        ...
                        <tbody>
                            ...
                            <tr>
                               ...
                               <td style="padding-top:60px"> <select style="width:200px; height:35px" class="custom-select" style="width:50% ; float:right!important"autocomplete="on"  id="inlineFormCustomSelect" name="id" required="required">
                                ...
                                <input type="text" class="selected" name="selected" id="selected">
                                ...
                                <?php
                                   ...
                                   ?>
                                   <input type="hidden" class="acadimyNum" value=<?php $row1['id_academicadvisor']?> name="acadimyNum">
