                    ...
                    <table class="table table-dark table-hover text-center" style="padding:8px;text-align:center;">
                        ...
                        <tbody>
                            ...
                            <tr>
                               ...
                               <td style="padding-top:60px"> <select style="width:200px; height:35px" id="ddlViewBy" class="custom-select" style="width:50% ; float:right!important"autocomplete="on"  id="inlineFormCustomSelect" name="id" required="required">
                                ...
                                <?php
                                        ...
                                        $con = new mysqli("localhost", "root", "", "traino");
                                        $stm1 = $con->prepare('select * from student where id_academicadvisor = "'.$_POST['selected'].'"');
                                        $stm1->execute();
                                        $rs1 = $stm1->get_result();
                                        while ($row1 = $rs1->fetch_assoc()){
                                        extract($row1);
                                        $acadimyNum=$row1['id_academicadvisor'];
                                        }
