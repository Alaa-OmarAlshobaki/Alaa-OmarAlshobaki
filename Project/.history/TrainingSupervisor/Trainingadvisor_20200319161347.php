...
<html>
<script type="text/javascript" src="PROJEC/js/jquery.js"></script>
                    ...
                    <table class="table table-dark table-hover text-center" style="padding:8px;text-align:center;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="padding-top: 60px"><input type="text"class="form-control has-warning" id="Sun" name="Sun" placeholder="number of hours"></td>
                                <td style="padding-top: 60px"><input type="text"class="form-control has-warning" id="Mon" name="Mon" placeholder="number of hours"></td>
                                <td style="padding-top: 60px"><input type="text"class="form-control has-warning" id="Tues" name="Tues" placeholder="number of hours"></td>
                                <td style="padding-top: 60px"><input type="text"class="form-control has-warning" id="Wed" name="Wed" placeholder="number of hours"></td>
                                <td style="padding-top: 60px"><input type="text"class="form-control has-warning" id="Thurs" name="Thurs" placeholder="number of hours"></td>
                                <td style="padding-top: 60px"><label id="numHours" style="width:100px">num of hours</label></td>
