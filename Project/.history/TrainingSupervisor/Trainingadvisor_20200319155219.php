                    ...
                    <table class="table table-dark table-hover text-center" style="padding:8px;text-align:center;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="padding-top: 60px"><input type="text"class="form-control has-warning" id="Sun" name="Wed" placeholder="number of hours"></td>
                                <td style="padding-top: 60px"><input type="text"class="form-control has-warning" id="Sun" name="Thurs" placeholder="number of hours"></td>
