                    ...
                    <table class="table table-dark table-hover text-center" style="padding:8px;text-align:center;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="padding-top: 60px"><input type="number"class="form-control has-warning" name="Sun" placeholder="Student ID"></td>
                                <td style="padding-top: 60px"><input type="number"class="form-control has-warning" name="Mon" placeholder="Student ID"></td>
                                <td style="padding-top: 60px"><input type="number"class="form-control has-warning" name="Tues" placeholder="Student ID"></td>
                                <td style="padding-top: 60px"><input type="number"class="form-control has-warning" name="Wed" placeholder="Student ID"></td>
                                <td style="padding-top: 60px"><input type="number"class="form-control has-warning" name="Thurs" placeholder="Student ID"></td>
                                <td style="padding-top: 60px"><input type="number"class="form-control has-warning" name="Num_of_Hours" placeholder="Student ID"></td>
