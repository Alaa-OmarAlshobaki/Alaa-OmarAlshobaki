    ...
    <form action="Viewattendance.php" method="post">
     ...
     <form method="Post">
                    ...
                    <table class="table table-dark table-hover text-center" style="padding:8px;text-align:center;">
                        ...
                        if (isset($_POST["s"])) {
                            ...
                            $st=$con->prepare(" SELECT * FROM attendance
                                                ...
                                                ON trainingadvisor.id = attendance.attendance
                                                where lecture_id = :bindedId
																			AND content_table.content_status= 0")
      ...
      echo "<tr>";
         ...
         echo "<td>".$row["id_student"]."</td>"."<br/>";
         echo "<td>".$row["attendance_date"]."</td>"."<br/>";
         echo"<td>". $row["numHours"]."</td>"."<br/>";
