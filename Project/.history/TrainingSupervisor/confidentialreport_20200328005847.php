...
extract($row);  ?>
            Name of orgnization :<input class="b1" type="text"name="organizationName"/><?php }} ?><br><br>
            Name of supervisor :<input class="b1" type="text"name="supervisorName"/><br><br><br><br><br>
            signture : 
