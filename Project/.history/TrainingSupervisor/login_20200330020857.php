...
<?php
session_start();
require_once 'C:\xampp\htdocs\Project\TrainingSupervisor\chat\class\user.php';
        ...
        $hashPass=sha1($password);
          ...
          $stmLogin->execute();
                ...
                if($stmLogin->rowCount()>0){
                    ...
                    $logincheck = $user2->login_check($username,$password);
...
<head>
    ...
    <title>login TrainingAdvisor</title>
</head>
<body>
...
<div class="shadow-lg p-3 bg-white rounded m-10">
    <h3 class="text-center ">TrainingAdvisor LOGIN</h3>
