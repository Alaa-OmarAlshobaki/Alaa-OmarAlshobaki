                    ...
                    <table class="table table-dark table-hover text-center" style="padding:8px;text-align:center;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="padding-top: 60px"><input type="text"class="form-control has-warning" name="Sun" placeholder="number of hours"></td>
                                <td style="padding-top: 60px"><input type="text"class="form-control has-warning" name="Mon" placeholder="number of hours"></td>
                                ...
                                <td style="padding-top: 60px"><center><label style="width:100px" type="button" name="s"class="btn btn-info ">Submit</label></center>
                                </td>
