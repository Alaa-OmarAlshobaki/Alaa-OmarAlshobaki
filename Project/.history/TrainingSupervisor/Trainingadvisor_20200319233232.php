                    ...
                    <table class="table table-dark table-hover text-center" style="padding:8px;text-align:center;">
                        ...
                        <tbody>
                            ...
                            <tr>
                               ...
                               <td style="padding-top:60px"> <select style="width:200px; hie" class="custom-select" style="width:50% ; float:right!important"autocomplete="on"  id="inlineFormCustomSelect" name="id" required="required">
