...
//        while ($row = $rs->fetch_assoc()) {
  ...
  ON insidejordan.id_academicadvisor= academicadvisor.id_student
         where increment=?");
...
<section class="borderpage" style="margin-left:400px;">
            ...
            <div style="width:728px">
                ...
                <input class="b1" type="text" name="AcademicSupervisor"value="<?php echo $row['id_academicadvisor'] ?>"/><br><br>
