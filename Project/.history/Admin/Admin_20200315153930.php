                    ...
                    <?php
                        ...
                        while ($row=$rs->fetch_assoc())
                        {
                            ...
                            echo"<td>". $row["AcademicSupervisor"]."</td>";
                              ...
                              echo "<td><a href='/PROJECT/Admin/addStudent.php?id='ec><i class='fas fa-user-plus btn' data-toggle='tooltip' title='Add student'  style='font-size:15px ;padding:0px ''></i></a> </td>";
                        }
