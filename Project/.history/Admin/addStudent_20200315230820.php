...
require 'phpmailer\phpmailer\srcPHPMailer.php';
...
<?php
         function sendEmail( $to,$message) {
            ...
            try {
                ...
                $mail->Username   = 'walaaalshobaki956@gmail.com';                     // SMTP username
                $mail->Password   = '1471996walaa';                               // SMTP password
                $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;         // Enable TLS encryption; `PHPMailer::ENCRYPTION_SMTPS` encouraged
                $mail->Port       = 587;                                    // TCP port to connect to, use 465 for `PHPMailer::ENCRYPTION_SMTPS` above
            
                //Recipients
                $mail->setFrom('walaaalshobaki956@gmail.com', 'Mailer');
                $mail->addAddress('walaaalshobaki956@gmail.com', 'Joe User');     // Add a recipient
                $mail->addAddress('walaaalshobaki956@gmail.com');               // Name is optional
                $mail->addReplyTo('walaaalshobaki956@gmail.com', 'Information');
                $mail->addCC('walaaalshobaki956@gmail.com');
                $mail->addBCC('walaaalshobaki956@gmail.com');
