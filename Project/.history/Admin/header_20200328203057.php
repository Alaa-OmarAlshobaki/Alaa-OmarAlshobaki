                      ...
                      <li><a href="login.php">LOGIN</a></li>';
                            ...
                            <li class="menu-has-Reports"><a href="#">Reports</a>
                                ...
                                <ul>
                                    ...
                                    <li><a href="viewconfidentialreport.php">Confidential Report</a></li>
                                    <li><a href="finalreport.php">Confidential Report</a></li>
                            ...
                            <li><a href="CahtWeb/chat.php">Chat</a> </li>
                             ...
                             <li><a href="rejectstudent.php"> Reject Student</a> </li>
                             <li><a href="ViewAcademicAdvisor.php"> Add Academic Advisor</a> </li>
