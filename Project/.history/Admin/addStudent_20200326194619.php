                        ...
                        ,'".$_POST["supervisorPhone"]."'
                         ...
                         if ($con->query($sql) === TRUE ) {
                            ...
                            sendmail($_POST["supervisorEmail"] ,"The student is registered for training. You have the student's name:".$_POST["studentName"]."
                               ...
                               $sql2 = "INSERT INTO student (serialNumber, name, studentid,major,personalnumber,homenumber,email,password,id_academicadvisor,id_trainingadvisor)
                               VALUES ('".$_POST["serialNumber"]."'
                               ,'".$_POST["studentName"]."'
                               ,'".$_POST["ID"]."'
                               ,'".$_POST["major"]."'
                               ...
                               echo $id_inc;
                               $status="accept";
                               $q_ins='UPDATE insidejordan SET (status) VALUES("'.$status.'") WHERE increment="'. $id_inc.'"'; 
