...
//        while ($row = $rs->fetch_assoc()) {
    if (isset($_GET["increment"])) {
        ...
        $st = $con->prepare("SELECT *  FROM insidejordan
                                       ...
                                       ON insidejordan.id_academicadvisor= academicadvisor.id
                                      WHERE increment=?");
...
<section class="borderpage" style="margin-left:400px;">
            ...
            <div style="width:728px">
                ...
                <input class="b1" type="text" name="id_acadi" value="<?php echo $row['id'] ?>"/><br><br>
           ...
           class="btn-danger"/><br></div>     
            ...
            if (isset($_POST["s"])) {
                ...
                if ($con->connect_error) {
                    ...
                    $sql = "INSERT INTO student (serialNumber, name, studentid,major,personalnumber,homenumber,email,password,id_academicadvisor)
                    ...
                    if ($con->query($sql1) === TRUE  $con->query($sql1) === TRUE) {
