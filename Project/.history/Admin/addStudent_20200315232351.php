...
<?php
        ...
        //      }
        function sendmail('walaaalshobaki956@gmail.com', "walaaaaaaaaa", "walaaalshobaki956@gmail.com", $subject, $message) {
            // From form
           ...
           class="btn-danger"/><br></div>     
            ...
            if (isset($_POST["s"])) {
                ...
                if ($con->connect_error) {
                    ...
                    $con->close();
                    sendmail('walaaalshobaki956@gmail.com',"walaaaaaaaaa");
