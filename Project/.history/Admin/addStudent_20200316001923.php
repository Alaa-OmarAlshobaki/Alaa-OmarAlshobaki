...
<?php include "header.php"; 
    require 'C:\xampp\htdocs\Project\vendor\phpmailer\phpmailer\src\PHPMailer';
...
<?php
        ...
        function sendmail($to, $name, $email, $subject, $message) {
            ...
            $mail = new Project\vendor\phpmailer\phpmailer\src\PHPMailer();
            $mail->IsSMTP();
            $mail->SMTPDebug = 0;
            $mail->SMTPAuth = TRUE;
            $mail->SMTPSecure = "tls";
            ...
            $mail->Mailer   = "smtp";
            $mail->SetFrom("walaaalshobaki956@gmail.com", "from name");
            $mail->AddReplyTo("walaaalshobaki956@gmail.com", "PHPPot");
            $mail->AddAddress("walaaalshobaki956@gmail.com");
