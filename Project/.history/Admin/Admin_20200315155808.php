            ...
            <tr scope="row">
                    <?php
                        ...
                        <td>
                            ...
                            <a href="/PROJECT/Admin/addStudent.php?id=<?php echo $increment  ?>" ><i class='fas fa-user-plus btn' data-toggle='tooltip' title='Add student'  style='font-size:15px ;padding:0px '></i></a> </a> data-name="<?php echo $rowSelectCom['company_name'] ; ?>" data-id="<?php echo $rowSelectCom['company_id'] ; ?>" class="edit editEmployeeBtn" ><i class="fas fa-edit btn" data-toggle="tooltip" style="font-size:15px" title="Edit"></i></a>
