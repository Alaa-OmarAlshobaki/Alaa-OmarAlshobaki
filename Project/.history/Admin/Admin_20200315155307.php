            ...
            <tr scope="row">
                    <?php
                        ...
                        { extract($row);
                            ...
                            <tr>
                        <td><?php echo $rowrowSelectCom['increment'] ; ?></td>
                        <td><?php echo $rowSelectCom['company_name'] ; ?></td>
                        <td>
                            
                            <a href="javascript:void(0)"  data-name="<?php echo $rowSelectCom['company_name'] ; ?>" data-id="<?php echo $rowSelectCom['company_id'] ; ?>" class="edit editEmployeeBtn" ><i class="fas fa-edit btn" data-toggle="tooltip" style="font-size:15px" title="Edit"></i></a>
