           ...
           class="btn-danger"/><br></div>     
            ...
            if (isset($_POST["s"])) {
                ...
                if ($con->connect_error) {
                    ...
                    $academicid=htmlspecialchars(strip_tags($_POST["customreName1"]));
                    $stm="SELECT academicid FROM academicadvisor WHERE academicid = :academicid";
 $stmRig->bindParam(':customEmail', $customEmail);
$stmRig->execute();

if($stmRig->rowCount()>0){
