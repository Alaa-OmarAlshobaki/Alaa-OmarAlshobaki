...
<section class="borderpage" style="margin-left:400px;">
            ...
            <div style="width:728px">
                ...
                <label for="Academic Supervisor">9-Academic Supervisor :</label>
                <select style="width:200px; height:35px" class="custom-select" style="width:50% ; float:right!important"autocomplete="on"  id="inlineFormCustomSelect" name="id" required="required">
