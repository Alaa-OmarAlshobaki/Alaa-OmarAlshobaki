           ...
           class="btn-danger"/><br></div>     
            ...
            if (isset($_POST["s"])) {
                ...
                if ($con->connect_error) {
                    ...
                    $sql = "INSERT INTO insidejordan (serialNumber, studentName, ID,major,personalnumber,homenumber,email,companyAddress,country,city
                    ,companyName,Area,companyEmail,companyLocation,fax,phone,supervisorPhone,supervisorEmail,Trainingfield,AcademicSupervisor,pledge,Studentsignature,location)
...
<!-- <?php
 ...
 $sql = "INSERT INTO student (serialNumber,
 name,  
 studentid,
 major,
 personalnumber,
 ...
 $stmt->execute([$serialNumber, $studentName, $ID,$major,$personalnumber,$homenumber,$email,$password]);
//   if($_SERVER["REQUEST_METHOD"] == "POST"){
//     $con=new mysqli("localhost","root","","traino");
//     $serialNumber=htmlspecialchars(strip_tags($_POST['serialNumber']));         
//     $studentName=htmlspecialchars(strip_tags($_POST['studentName']));
//     $ID=htmlspecialchars(strip_tags($_POST['ID']));
//     $major=htmlspecialchars(strip_tags($_POST['major']));
//     $personalnumber=htmlspecialchars(strip_tags($_POST['personalnumber']));
//     $homenumber=htmlspecialchars(strip_tags($_POST['homenumber']));
//     $email=htmlspecialchars(strip_tags($_POST['email']));
//     $password=randomPassword();



//       $stmAddRecVou=$con->prepare("INSERT INTO student( serialNumber,
//                                                               name,  
//                                                               studentid,
//                                                               major,
//                                                               personalnumber,
...
//                                                            ");
//       $stmAddRecVou->bindParam(':serialNumber' , $serialNumber );
//       $stmAddRecVou->bindParam(':name' , $studentName );
//       $stmAddRecVou->bindParam(':studentid' , $ID );
//       $stmAddRecVou->bindParam(':major' , $major );
//       $stmAddRecVou->bindParam(':personalnumber' , $personalnumber );
//       $stmAddRecVou->bindParam(':homenumber' , $homenumber );
//       $stmAddRecVou->bindParam(':email' , $email );
//       $stmAddRecVou->bindParam(':password' , $password );
//       if($stmAddRecVou->execute()){
