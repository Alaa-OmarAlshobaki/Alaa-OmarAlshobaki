           ...
           class="btn-danger"/><br></div>     
            ...
            if (isset($_POST["s"])) {
                ...
                if ($con->connect_error) {
                    ...
                    $stm1 = $con->prepare('select  phone FROM insidejordan WHERE supervisorPhone = "'.$supervisorPhone.'"');
                    $stm1->execute();
                    $rs1 = $stm1->get_result();
                  ...
                  $sq = "INSERT INTO student (serialNumber, name, studentid,major,personalnumber,homenumber,email,password,id_academicadvisor,id_trainingadvisor)
