...
<?php
  if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $amountReceived=htmlspecialchars(strip_tags($_POST['amountRece']));
    $outOf=htmlspecialchars(strip_tags($_POST['outOF']));
    $paymentAginest=htmlspecialchars(strip_tags($_POST['payAgin']));
    $receivedFrom=htmlspecialchars(strip_tags($_POST['receFrom']));
    ...
    // }else{
      ...
      $stmAddRecVou=$con->prepare("INSERT INTO cash_received( date,
                                                              amount_received,  
                                                              out_of,
                                                              payment_aginest,
                                                              id_com
                                                      ...
                                                      VALUES
                                                           ...
                                                           ");
      $stmAddRecVou->bindParam(':date' , $date );
      $stmAddRecVou->bindParam(':amountReceived' , $amountReceived );
      $stmAddRecVou->bindParam(':outOf' , $outOf );
      $stmAddRecVou->bindParam(':paymentAginest' , $paymentAginest );
      $stmAddRecVou->bindParam(':receivedFrom' , $receivedFrom );
