...
$(document).ready(function(){
    ...
    <body>
         ...
         <table border =1 width=70% class="table table-striped">
            ...
            <tr scope="row">
                    <?php
                        $con = new mysqli("localhost:localhost","root","","traino");
                        ...
                        while ($row=$rs->fetch_assoc())
                        {
                            ...
                            //         </td>';
                              echo '<td><a href="add.php"><i class="fas fa-file-export btn" data-toggle="tooltip" title="Add student"  style="font-size:15px ;padding:0px "></i></a> </td>';
                        }
