        ...
        <div class="container wow fadeInUp">
            <div class="col-md-6 col-md-push-3">
                <div class="form-signup">
                    ...
                    <input type="number" name="advisorid" placeholder="AdvisorID"
                           class="form-control" style="width:100%" required/><br/>
...
<?php 
    ...
    if(isset($_POST["s"]))
    {
        if($_POST["password"]==$_POST["confirm"])
        {
            ...
            $st=$con->prepare("select email from trainingadvisor where email=?");
            ...
            $st=$con->prepare("insert into trainingadvisor(name,advisorid,email,password) values(?,?,?,?)");
            $st->bind_param("siss", $_POST["name"],$_POST["advisorid"],
